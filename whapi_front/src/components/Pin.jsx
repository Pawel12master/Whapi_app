          ...
          >
            <div className="flex items-center justify-between">
              ...
              {alreadySaved?.length !== 0 ? (
                <button
                  type="button"
                  className="bg-orange-500 opacity-70 hover:opacity-100 text-white font-bold px-5 py-1 text-base rounded-3xl hover:shadow-md outline-none"
                >
            ...
            <div className="flex flex justify-between items-center gap-2 w-full">
              ...
              {postedBy?._id === user?.googleId && (
                <button
                  ...
                  className="bg-orange-500 opacity-70 hover:opacity-100 text-white font-bold text-base rounded-full hover:shadow-md outline-none p-2"
                >
                  <AiTwotoneDelete />
                </button>
              )}
