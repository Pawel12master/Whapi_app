...
import { pinDetailMorePinQuery, pinDetailQuery } from "../utills/data";
          ...
          <div className="flex items-start justify-between">
            <div className="flex gap-2 items-center">
              <a
                ...
                className="bg-orange-500 w-9 h-9 rounded-full flex items-center justify-center text-white text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none"
              >
